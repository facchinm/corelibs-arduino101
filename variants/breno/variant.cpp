...
//     gpio port          type       base                   soc pin mux mode       pwm chan pwm scale        adc channel pin mode
    ...
    { 29,   SOC_GPIO_32,  SOC_GPIO,  SOC_GPIO_BASE_ADDR,    63,     GPIO_MUX_MODE, INVALID, INVALID,         INVALID, INPUT_MODE }, // Arduino IO25
    { 30,   SOC_GPIO_32,  SOC_GPIO,  SOC_GPIO_BASE_ADDR,    64,     GPIO_MUX_MODE, INVALID, INVALID,         INVALID, INPUT_MODE }, // Arduino IO25
