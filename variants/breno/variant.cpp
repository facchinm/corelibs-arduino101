...
//     gpio port          type       base                   soc pin mux mode       pwm chan pwm scale        adc channel pin mode
    { 19,   SOC_GPIO_32,  SOC_GPIO,  SOC_GPIO_BASE_ADDR,    53,     GPIO_MUX_MODE, INVALID, INVALID,         INVALID, INPUT_MODE }, // Arduino IO0
    ...
    { 29,   SOC_GPIO_32,  SOC_GPIO,  SOC_GPIO_BASE_ADDR,    33,     GPIO_MUX_MODE_ALTERNATE, INVALID, INVALID,         INVALID, INPUT_MODE }, // Arduino IO25
    { 30,   SOC_GPIO_32,  SOC_GPIO,  SOC_GPIO_BASE_ADDR,    34,     GPIO_MUX_MODE_ALTERNATE, INVALID, INVALID,         INVALID, INPUT_MODE }, // Arduino IO25
